...
const TaskList = (): JSX.Element => {
  ...
  return (
    <div style={styles.container}>
      ...
      {isModalOpen && <TaskModal headingTitle="Add your task" type={TASK_MODAL_TYPE.ADD} setIsModalOpen={setIsModalOpen} defaultProgressOrder={TASK_PROGRESS_ID.NOT_STARTED} />}
    </div>
  );
};
